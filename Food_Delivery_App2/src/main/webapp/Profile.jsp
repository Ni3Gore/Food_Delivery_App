<%@page import="com.food.daoImplementation.*"%>
<%@page import="com.food.model.Order"%>
<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8"%>
<%@ page
	import="java.util.List, com.food.model.Restaurant, com.food.model.Order, com.food.model.Menu, com.food.model.OrderItem, com.food.model.User, com.food.daoImplementation.RestaurantDAOImpl, com.food.daoImplementation.MenuDAOImpl, com.food.daoImplementation.OrderDAOImpl,com.food.daoImplementation.OrderItemDAOImpl"%>
<!DOCTYPE html>
<html lang="en">
<head>
<meta charset="UTF-8">
...
<body>
	...
	<header>
		...
		<div class="header-buttons">
			<a href="cart"><button>Cart</button></a> <a href="Home"><button>Restaurants</button></a>
	...
	<div class="content">
		...
		<div class="order-history-box" id="order-history-box">
			...
			for (Order orders : allOrdersByUser) {
				...
				List<OrderItem> allorderitems = orderitemimpl.getAllOrderItemByOrder(orderId);
			%>
			...
			<div class="order-item">
				...
				<div class="order-details">
					...
					<p class="order-total">
						Total Amount:&#8377;<%=orders.getTotalAmount()%></p>
					<p class="order-paymentMethod">
						Payment Method:<%=orders.getPaymentMethod()%></p>
				</div>
			</div>
